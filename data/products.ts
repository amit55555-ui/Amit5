...
export const PRODUCTS: Product[] = [
  ...
  // ── בית ואחסון ──
  { id:'p036', name:'קופסאות אחסון מודולריות שקופות – סט 6', cat:'storage', desc:'שישה קופסאות שקופות בגדלים שונים לארון/מגירה. ניתן לגיבוב, עם מכסה נגד אבק.', price:'65', orig:'120', link:'https://s.click.aliexpress.com/e/_olDh6Gx', emoji:'📦', badge:'top', stars:5 },
  { id:'p037', name:'ווי נשלפים לקיר ללא קידוח – 20 יח\'', cat:'storage', desc:'ווים דביקים נשלפים לקיר, נשאים עד 5 ק"ג כל אחד. אין קידוח, אין עקבות. 20 יחידות.', price:'25', orig:'45', link:'https://s.click.aliexpress.com/e/_oFRbGLh', emoji:'🪝', badge:'rec', stars:4 },
  { id:'p038', name:'אורגנייזר מגירת מטבח – סט 9 תאים', cat:'storage', desc:'מגש ארגון מגירה עם 9 תאים, מידות מתכווננות. חומר PP עמיד, קל לניקוי, גובה 5 ס"מ.', price:'45', orig:'80', link:'https://s.click.aliexpress.com/e/_oBxnpkx', emoji:'🗂️', badge:'new', stars:4 },
  { id:'p039', name:'מנשא תיקים אנכי לארון – 6 ווים', cat:'storage', desc:'מתלה 6 ווים לדלת/קיר לתיקים, ניות וצעיפים. אלומיניום+סיליקון, נשיאה 15 ק"ג.', price:'35', orig:'65', link:'https://s.click.aliexpress.com/e/_okByDwp', emoji:'👜', badge:'sale', stars:5 },
  { id:'p040', name:'שקיות ואקום לחיסכון במקום – סט 10', cat:'storage', desc:'10 שקיות ואקום (5 גדולות + 5 קטנות) למיטות, שמיכות ובגדים. חיסכון 80% מקום.', price:'55', orig:'99', link:'https://s.click.aliexpress.com/e/_oE9MBqX', emoji:'🛍️', badge:'top', stars:5 },
];
